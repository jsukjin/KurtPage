...
- [템플릿 특수화](#%ED%85%9C%ED%94%8C%EB%A6%BF-%ED%8A%B9%EC%88%98%ED%99%94)
	- [1. 사용이유](#1-%EC%82%AC%EC%9A%A9%EC%9D%B4%EC%9C%A0)
	- [2. 예제 코드](#2-%EC%98%88%EC%A0%9C-%EC%BD%94%EB%93%9C)
	- [2. 실제 코드](#2-%EC%8B%A4%EC%A0%9C-%EC%BD%94%EB%93%9C)
...
## 1. 사용이유
- 같은 템플릿인데 특정 타입일때는 다르게 동작하기 위해서
...
> [!info] info
> 일반 템플릿 : 모든 타입에 대한 기본 구현<br>
> 완전 특수화 : 특정 타입 하나만 다르게<br>
> 부분 특수화 : 특정 패턴 (포인터, 배열 등) 다르게 <br>
